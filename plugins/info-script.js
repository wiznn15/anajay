...
var handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  let str = `https://www.memedroid.com/`;
  let waifu = await fetch(
    "https://raw.githubusercontent.com/ArugaZ/grabbed-results/main/random/anime/waifu.txt",
  );
  ...
  let stiker = await sticker(
    null,
    global.API(`https://telegra.ph/file/64cbeccd8b371daf4746a.jpg`),
    global.packname,
    global.author,
  );
  await delay(3000);
