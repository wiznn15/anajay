...
ᴜɴᴛᴜᴋ ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴀʟʟᴍᴇɴᴜ ᴋᴇᴛɪᴋ *.ᴀʟʟᴍᴇɴᴜ*`;
  ...
  let { age, exp, limit, level, role, registered, eris } =
    ...
    null,
    {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          thumbnail: await (
            await fetch(`https://telegra.ph/file/9016abd0ea18f4578957f.jpg`)
          ).buffer(),
          sourceUrl: "https://www.memedroid.com/",
        },
      },
    },
    { quoted: fkon },
  ...
  let elaina = {
    audio: fs.readFileSync("./vn/menuawal.mp3"),
    mimetype: "audio/mpeg",
    ptt: true,
    viewOnce: true,
    thumbnaiUrl: thumb,
